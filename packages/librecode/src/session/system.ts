...
export function systemPromptInstructions(): string {
  return PROMPT_CODEX.trim()
}

export function systemPromptProvider(model: Provider.Model): string[] {
...
export async function systemPromptEnvironment(model: Provider.Model): Promise<string[]> {
...
export async function systemPromptSkills(agent: AgentInfo): Promise<string | undefined> {
