...
export function toRow(info: _Info) {
  return {
    id: info.id,
...
type _Info = z.output<typeof Info>
...
type _ProjectInfo = z.output<typeof ProjectInfo>
...
type _GlobalInfo = z.output<typeof GlobalInfo>
...
// Barrel export preserving Session.X access pattern for consumers
...
export namespace Session {
  ...
  export type GlobalInfo = _GlobalInfo
}
