 ...
 */
function providerCredentialsGet(providerID: string): CredentialData | undefined {
...
function providerCredentialsSet(providerID: string, data: CredentialData): void {
...
function providerCredentialsRemove(providerID: string): void {
  Database.use((db) =>
...
export const ProviderCredentials = {
  get: providerCredentialsGet,
  set: providerCredentialsSet,
  remove: providerCredentialsRemove,
} as const
