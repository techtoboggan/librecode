...
async function readDarwinImage(): Promise<ClipboardContent | undefined> {
...
async function readWin32Image(): Promise<ClipboardContent | undefined> {
  const script =
...
async function readLinuxImage(): Promise<ClipboardContent | undefined> {
