...
import librecode from "./theme/librecode.json" with { type: "json" }
...
export function generateSyntax(theme: Theme): ReturnType<typeof SyntaxStyle.fromTheme> {
  return SyntaxStyle.fromTheme(getSyntaxRules(theme))
}

export function generateSubtleSyntax(theme: Theme): ReturnType<typeof SyntaxStyle.fromTheme> {
