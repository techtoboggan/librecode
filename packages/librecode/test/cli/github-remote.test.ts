...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/librecode.git")).toEqual({ owner: "sst", repo: "librecode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/librecode")).toEqual({ owner: "sst", repo: "librecode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/librecode.git")).toEqual({ owner: "sst", repo: "librecode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/librecode")).toEqual({ owner: "sst", repo: "librecode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/librecode.git")).toEqual({ owner: "sst", repo: "librecode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/librecode")).toEqual({ owner: "sst", repo: "librecode" })
})
