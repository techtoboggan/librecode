...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new LibrecodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class Provider extends HeyApiClient {
  ...
  /**
   * Scan for local model servers
   *
   * Scan localhost and optionally the local network for OpenAI-compatible model servers.
   */
  public scan<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<ProviderScanResponses, unknown, ThrowOnError>({
      url: "/provider/scan",
      ...options,
      ...params,
      headers: {
...
export class LibrecodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<LibrecodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    LibrecodeClient.__registry.set(this, args?.key)
  }
