...
export const dict = {
  ...
  "dialog.provider.librecode.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.librecode.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.librecodeGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.unpaid.freeModels.title": "LibreCode에서 제공하는 무료 모델",
  ...
  "provider.connect.librecodeZen.line1":
    "LibreCode Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  "provider.connect.librecodeZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.librecodeZen.visit.prefix": "다음 ",
  "provider.connect.librecodeZen.visit.link": "librecode.io/zen",
  "provider.connect.librecodeZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "sidebar.gettingStarted.line1": "LibreCode에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
