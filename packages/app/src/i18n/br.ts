export const dict = {
  ...
  "dialog.provider.librecode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.librecode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.librecodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo LibreCode",
  ...
  "provider.connect.librecodeZen.line1":
    "LibreCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.librecodeZen.visit.prefix": "Visite ",
  "provider.connect.librecodeZen.visit.link": "librecode.io/zen",
  "provider.connect.librecodeZen.visit.suffix": " para obter sua chave de API.",
  ...
  "sidebar.gettingStarted.line1": "LibreCode inclui modelos gratuitos para você começar imediatamente.",
