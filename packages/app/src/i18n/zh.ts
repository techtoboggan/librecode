...
export const dict = {
  ...
  "dialog.provider.librecode.note": "使用 LibreCode Zen 或 API 密钥连接",
  "dialog.provider.librecode.tagline": "可靠的优化模型",
  "dialog.provider.librecodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "LibreCode 提供的免费模型",
  ...
  "sidebar.gettingStarted.line1": "LibreCode 提供免费模型，你可以立即开始使用。",
