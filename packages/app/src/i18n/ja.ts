export const dict = {
  ...
  "dialog.provider.librecode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.librecode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.librecodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "LibreCodeが提供する無料モデル",
  ...
  "provider.connect.librecodeZen.line1":
    "LibreCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.librecodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.librecodeZen.visit.prefix": " ",
  "provider.connect.librecodeZen.visit.link": "librecode.io/zen",
  "provider.connect.librecodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "sidebar.gettingStarted.line1": "LibreCodeには無料モデルが含まれているため、すぐに開始できます。",
