export const dict = {
  ...
  "dialog.provider.librecode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.librecode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.librecodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من LibreCode",
  ...
  "provider.connect.librecodeZen.line1":
    "يمنحك LibreCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.librecodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.librecodeZen.visit.link": "librecode.io/zen",
  "provider.connect.librecodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "sidebar.gettingStarted.line1": "يتضمن LibreCode نماذج مجانية حتى تتمكن من البدء فورًا.",
