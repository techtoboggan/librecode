export const dict = {
  ...
  "dialog.provider.librecode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.librecode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.librecodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez LibreCode",
  ...
  "provider.connect.librecodeZen.line1":
    "LibreCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.librecodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.librecodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.librecodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "sidebar.gettingStarted.line1": "LibreCode zawiera darmowe modele, więc możesz zacząć od razu.",
