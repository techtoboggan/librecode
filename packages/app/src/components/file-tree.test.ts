...
beforeAll(async () => {
  ...
  mock.module("@librecode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@librecode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@librecode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@librecode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
