import type { Message, Session, TextPart, UserMessage } from "@librecode/sdk/v2/client"
import { Avatar } from "@librecode/ui/avatar"
import { HoverCard } from "@librecode/ui/hover-card"
import { Icon } from "@librecode/ui/icon"
import { IconButton } from "@librecode/ui/icon-button"
import { MessageNav } from "@librecode/ui/message-nav"
...
const LIBRECODE_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === LIBRECODE_PROJECT_ID ? "https://github.com/techtoboggan/librecode/favicon.svg" : props.project.icon?.override
          }
