...
import { PinnedAppsProvider } from "@/context/pinned-apps"
...
/** McpAppResource for the Session Stats built-in — supplied to <AppDock> as the prototype example. */
const BUILTIN_SESSION_STATS: McpAppResource = {
  server: "__builtin__",
  name: "Session Stats",
  uri: BUILTIN_URI_SESSION_STATS,
