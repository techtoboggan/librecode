// This file is generated by the icon spritesheet generator. Do not edit by
// hand — run the generator to regenerate.
//
// CLAUDE.md file-size rule exception: this file is auto-generated from the
// icon sprite sheet and is one entry per icon name. Splitting it would
// mean either lying to the generator or creating a pointless barrel. The
// 1000-line rule is about manually-authored code — codegen output doesn't
// benefit from decomposition. Tracked in PLAN.md Phase 30 exceptions.
