...
//
// CLAUDE.md file-size rule — category 1 exception (codegen output).
// One entry per icon name; splitting would either lie to the generator
// or create a pointless barrel.
