...
const docs = `### Overview
Loads LibreCode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>LibreCode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>LibreCode Mono Sample</div>
    </div>
  ),
}
