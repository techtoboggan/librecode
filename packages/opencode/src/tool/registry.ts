...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@librecode/plugin"
import z from "zod"
      ...
      tools
        .filter((t) => {
          ...
          if (t.id === "codesearch" || t.id === "websearch") {
            return model.providerID === ProviderID.librecode || Flag.LIBRECODE_ENABLE_EXA
          }
